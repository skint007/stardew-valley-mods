...
| [Level Up](levelup/README.md) | 1.3.4 | A meta player-level system earned from in-world actions (kills, days, quests), with milestone-based stat bonuses fully configurable via GMCM. |
